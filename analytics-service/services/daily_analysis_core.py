...
Refactored from daily_analysis.py for FastAPI integration
"""
...
def analyze_daily_feedback(date_str: str, include_charts: bool = True) -> dict:
    """
    ...
    try:
        ...
        return {
            "error": True,
            "message": f"Daily analysis failed: {str(e)}",
            "status": "error"
        }
    finally:
        db_conn.close()
